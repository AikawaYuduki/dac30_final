...
class MyUpdater(training.StandardUpdater):
    def __init__(self, iterator, base, base_optimizers, converter=convert.concat_examples, device=None):
        ...
        self._optimizers = {}
        for i in range(0, len(base_optimizers)):
            self._optimizers[str(i)] = base_optimizers[i]
